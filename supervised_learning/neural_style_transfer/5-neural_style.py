...
class NST:
    ...
    def layer_style_cost(self, style_output, gram_target):
        ...
        Args:
            style_output (tf.Tensor): shape (1, h, w, c), the layer style
                output of the generated image
            gram_target (tf.Tensor): shape (1, c, c), the gram matrix of
    ...
    def style_cost(self, style_outputs):
        ...
        for style_output, gram_target in zip(style_outputs,
            ...
            cost += weight * self.layer_style_cost(style_output,
                                                   gram_target)
